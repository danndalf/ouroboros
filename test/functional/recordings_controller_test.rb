...
class RecordingsControllerTest < ActionController::TestCase
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post :create, recording: { description: @recording.description, place: @recording.place, url: @recording.url, when: @recording.when }
    end
  ...
  test "should update recording" do
    put :update, id: @recording, recording: { description: @recording.description, place: @recording.place, url: @recording.url, when: @recording.when }
    assert_redirected_to recording_path(assigns(:recording))
  end
